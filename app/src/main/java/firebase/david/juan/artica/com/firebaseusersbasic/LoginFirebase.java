 ...
 */
public class LoginFirebase extends ActionBarActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFacebookAccessTokenTracker = new AccessTokenTracker() {
            ...
            protected void onCurrentAccessTokenChanged(AccessToken oldAccessToken, AccessToken currentAccessToken) {
                ...
                LoginFirebase.this.onFacebookAccessTokenChange(currentAccessToken);
            }
        };
        ...
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    token = GoogleAuthUtil.getToken(LoginFirebase.this, Plus.AccountApi.getAccountName(mGoogleApiClient), scope);
